...
//                                .padding()
//                                .frame(maxHeight: 40)
//                                .overlay(RoundedRectangle(cornerRadius: 12).stroke(viewModel.firstName.isEmpty ? .myLightGray : .black, lineWidth: 2.2))
//                        }
//
//
//                        VStack {
...
//                                .padding()
//                                .frame(maxHeight: 40)
//                                .overlay(RoundedRectangle(cornerRadius: 12).stroke(viewModel.lastName.isEmpty ? .myLightGray : .black, lineWidth: 2.2))
//                                .padding(.leading, 15)
//                        }
//                    }.padding(.trailing, 50)
//                        .padding(.leading, 50)
