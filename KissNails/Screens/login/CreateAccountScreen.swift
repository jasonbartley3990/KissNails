...
struct CreateAccountScreen: View {
    ...
    @State var privatePolicyUrl: String = "https://www.kissusa.com/pages/privacy"
    
    @State var termsUrl: String = "https://www.kissusa.com/pages/terms"
        ...
        ZStack {
            ...
            ScrollView {
                VStack {
                        ...
                        HStack {
                            ...
                            Button(action: {
                                ...
                                Image(systemName: viewModel.passwordHidden ? "eye.fill" : "eye.slash.fill")
                                    .foregroundColor(self.viewModel.passwordHidden ? Color.black : Color.myKiss)
                                    .padding(.trailing)
                            })
                    ...
                    HStack {
                        Text("8+ Characters      ").foregroundStyle(viewModel.isValidPasswordCount ? .myKiss : .gray)
                        Text("1 capital letter").foregroundStyle(viewModel.passwordContainsUppercase ? .myKiss : .gray)
                    }.font(.system(size: 15))
                        .padding(.bottom, 5)
                        ...
                        HStack {
                            ...
                            Button(action: {
                                ...
                                Image(systemName: viewModel.confirmPasswordHidden ? "eye.fill" : "eye.slash.fill")
                                    .foregroundColor(self.viewModel.confirmPasswordHidden ? Color.black : Color.myKiss)
                                    .padding(.trailing)
                            })
                            .buttonStyle(PlainButtonStyle())
