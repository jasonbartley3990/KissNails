        ...
        GeometryReader { geo in
            ZStack {
                ...
                VStack {
                    ...
                    HStack {
                        if !self.viewModel.isRetakeMode {
                        ...
                        VStack {
                            ...
                            HStack {
                                ...
                                VStack {
                                    ...
                                    Text("Capture")
                                        .foregroundStyle(viewModel.disableCaptureButton ?  .myDarkGray : .myKiss)
...
struct CaptureButton: View {
    ...
    var body: some View {
        ZStack {
            Text(" ").frame(width: 160, height: 50).background(Color(viewModel.isShowingLoadingView ? .myDarkGray : .myKiss)).foregroundStyle(.white).cornerRadius(30)
